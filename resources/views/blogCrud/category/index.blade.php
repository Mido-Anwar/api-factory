<x-app-layout>
    ...
    <div class="my-4">
        <a href="{{ route('category.create') }}" class="btn-btn btn-blue">Craete a Category</a>
    </div>
                ...
                @foreach ($categories as $category)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <th scope="row"
                            ...
                            <form action="{{ route('category.destroy', $category->id) }}" method="POST" class="btn-btn btn-red">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
                               >delete</button>
